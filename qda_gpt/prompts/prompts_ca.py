...
You are a qualitative data analyst performing content analysis. Your task is to analyze the provided dataset of transcribed interviews.
  ...
  2. Coding Subcategories: Organize similar units into broader subcategories based on patterns and similarities observed in the data. This phase involves sorting and collating all relevant units into potential subcategories to identify broader patterns of meaning.
  3. Coding Categories: Group subcategories into overarching categories that capture the major patterns and meanings in the data, providing comprehensive insights. This phase involves reviewing the subcategories to identify categories that are meaningful and significant in relation to the research questions or objectives.
...
1. Identify and extract units that describe or are related to the research questions or objectives. Focus on capturing the core message or idea relevant to the research.
2. One unit can be anything from a part of a sentence to a full interview response, depending on the completeness and relevance of the information.
3. Consider larger units when a full response provides essential context or meaning that cannot be captured in smaller fragments.
4. Extract multiple units from the same part of the text if they serve different aspects of the research objective. Each unit should independently convey a distinct code and aspect or insight.
5. Ensure the reduced data retains its meaning and relevance to the research questions or objectives. The extracted units should be concise yet comprehensive enough to reflect the original context.
6. Avoid redundant information that doesn't add value to the analysis. However, at this stage, it is better to identify too many than too few units.
7. Assign a fluent text code to each unit that succinctly captures its primary theme or idea. The code should be descriptive and limited to a maximum of two sentences.

For each unit, provide:
- Index number starting from 1,
- Code assigned to the unit (detailed level of abstraction, max two sentences),
- Unit text.
...
"Units": [
  {{
    "index": 1,
    "code": "Motivation derived from a sense of accomplishment",
    "text": "I am motivated by a sense of accomplishment."
  }},
  {{
    "index": 2,
    "code": "Motivation stemming from peer recognition",
    "text": "Recognition I receive from my peers."
  }},
  {{
    "index": 3,
    "code": "Motivation through setting and achieving personal goals",
  ...
  {{
    "index": 4,
    "code": "Motivation from positive feedback and challenging projects in the workplace",
...
ca_prompt2 = """
Read the interview transcripts provided and familiarize yourself with them, understanding the context. You are requested to perform coding for subcategories.

Guidelines for coding subcategories:
...
4. Ensure each unit code is assigned to only one subcategory. One subcategory can contain multiple unit codes.
5. Avoid redundancy and ensure each subcategory is distinct and meaningful. However, at this stage, it is better to identify too many than too few subcategories.
...
{{
  "Subcategories": [
    {{
      ...
      "definition": "This subcategory includes units that describe personal and external factors that motivate individuals. Significant properties include personal achievements, recognition from others, and internal drives. Units must mention at least one motivational factor.",
      "units": [
        {{
          "index": 1,
          "code": "Motivation from a sense of accomplishment",
          "rationale": "This unit discusses personal achievement, which is a key motivational factor."
        }},
        {{
          "index": 2,
          "code": "Motivation from recognition by peers",
    ...
    {{
      ...
      "definition": "This subcategory encompasses units that describe aspects of the work environment that influence individuals. Properties include teamwork, feedback, and community support. Units must refer to elements that contribute to a supportive and productive work setting.",
      "units": [
        {{
          "index": 3,
          "code": "Motivation from setting and achieving personal goals",
        ...
        {{
          "index": 4,
          "code": "Motivation from positive feedback and challenging projects",
...
Guidelines for coding categories:
1. Review the created subcategories and extract the essential information from each.
...
5. Ensure the categories retain their meaning and relevance to the research questions or objectives. Avoid redundant categories that don't add value to the analysis. However, at this stage, it is better to identify too many than too few categories.
6. Ensure each category is distinct and meaningful. Ensure that each category is conceptually coherent and that the subcategories within each category are closely related.
  ...
  "Categories": [
    {{
      ...
      "subcategories": [
        {{
          "subcategory_index": 1,
          "subcategory_label": "Achievement Motivation",
        ...
        {{
          "subcategory_index": 2,
          "subcategory_label": "Peer Recognition",
    ...
    {{
      ...
      "subcategories": [
        {{
          "subcategory_index": 3,
          "subcategory_label": "Team Dynamics",
        ...
        {{
          "subcategory_index": 4,
          "subcategory_label": "Feedback and Community",
...
ca_prompt4 = """
Read the interview transcripts provided and familiarize yourself with them, understanding the context. You are requested to assign subcategories to categories based on the data.

Guidelines for subcategory assignment and refinement:
1. Review the initial categories and subcategories, as well as their definitions created in the previous phases.
2. Assign subcategories to each category based on the transcribed interviews, regardless of any previously created subcategories. This is crucial for ensuring that subcategories are derived directly from the data.
3. Ensure each subcategory logically fits under its parent category.
4. Apply the subcategories to the interview data, ensuring to follow the provided examples and rules.
5. Ensure the subcategories retain their meaning and relevance to the research questions or objectives.
6. Assess the consistency and coherence of the subcategories.
7. Document the rationale for each subcategory assignment to ensure transparency and future reference.
8. Ensure each subcategory has a clear and concise definition, capturing its essence and criteria for inclusion.
  ...
  "Categories": [
    {{
      ...
      "subcategories": [
        {{
          "subcategory_index": 1,
          "subcategory_label": "Work-Life Balance",
        ...
        {{
          "subcategory_index": 2,
          "subcategory_label": "Career Advancement",
    ...
    {{
      ...
      "subcategories": [
        {{
          "subcategory_index": 3,
          "subcategory_label": "Mental Health Support",
        ...
        {{
          "subcategory_index": 4,
          "subcategory_label": "Physical Health Programs",
...
ca_prompt5 = """
Read the interview transcripts provided and familiarize yourself with them, understanding the context. You are requested to assign units to the refined subcategories and perform iterative refinement for the subcategories.
...
1. Review the refined subcategories and their definitions created in the previous message. Review the extracted units to understand the breadth of content.
...
8. Thoroughly ensure consistency and coherence of the subcategory definitions and unit assignments. Check for consistent criteria application across all assignments.
...
For each unit, provide:
- Unit index number starting from 1,
- Unit code (detailed level of abstraction, max two sentences),
- Unit text,
- The rationale for why this specific unit belongs to this subcategory.
  ...
  "Subcategories": [
    {{
      ...
      "units": [
        {{
          "unit_index": 1,
          "code": "Reduced back pain from ergonomic workstations",
        ...
        {{
          "unit_index": 2,
          "code": "Engagement through collaborative culture",
    ...
    {{
      ...
      "units": [
        {{
          "unit_index": 3,
          "code": "Comprehensive health insurance coverage",
        ...
        {{
          "unit_index": 4,
          "code": "Improved health through wellness programs",
...
6. Ensure that each category is conceptually coherent and that the subcategories within each category are closely related. Ensure each category is distinct and meaningful.
7. Document the rationale behind each category for transparency and future reference.
  ...
  "Categories": [
    {{
      ...
      "subcategories": [
        {{
          "subcategory_index": 1,
          "subcategory_label": "Leadership Training",
...
4. Ensure unique assignment by making sure each category is assigned to only one theoretical concept. One theoretical concept can contain one or more categories.
...
- A meaningful and compact definition of the concept, 2-3 sentences describing the most significant properties and requirements for a specific phenomenon to be identified as a theoretical concept,
  ...
  "Theoretical Concepts": [
    {{
      ...
      "categories": [
        ...
        {{
          "category_index": 2,
          "category_label": "Self-Fulfillment",
