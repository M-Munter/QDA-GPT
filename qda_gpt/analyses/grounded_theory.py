...
def phase5(request, response4_json):
    formatted_prompt5 = gt_prompt5.format(response4_json=response4_json)
...
def phase6(request, response5_json):
    formatted_prompt6 = gt_prompt6.format(response5_json=response5_json)
...
def phase7(request, response6_json):
    formatted_prompt7 = gt_prompt7.format(response6_json=response6_json)
